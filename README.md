...
|[claude-code-history-viewer](https://github.com/jhlee0409/claude-code-history-viewer)|[1.16.0](https://github.com/jhlee0409/claude-code-history-viewer)|The unified history viewer for AI coding assistants - browse, search, and analyze conversations from Claude Code, Gemini CLI, Codex CLI, Cline, Cursor, Aider, and OpenCode|
|[cli-proxy-api](https://github.com/router-for-me/CLIProxyAPI)|[7.2.27](https://github.com/router-for-me/CLIProxyAPI)|Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code, Qwen Code, iFlow as an OpenAI/Gemini/Claude/Codex compatible API service|
